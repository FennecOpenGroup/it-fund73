...
import Webpower from '../../assets/companies/Webpower.svg';
                ...
                <VStack w="full" px={0}>
                  ...
                  >
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #3E7DA2, #17baff)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Миссия Холдинга «ПромСервис» - внести свой вклад в превращение России в современное, эффективное
                        и развитое, удобное и безопасное для проживания и работы государство. Виды деятельности
                        направлены на обоснование и обеспечение энергоресурсосбережения для предприятий и организаций
                        практически всех отраслей экономики. Предприятия Холдинга «ПромСервис» предлагают заказчикам
                        различные комплексные решения в сфере энергоресурсосбережения объектов ЖКХ, отдельных
                        предприятий и городов в целом.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #e2b25f, #005d84)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        наших клиентов. Хотите избавиться от головной боли по поводу техчасти и сконцентрироваться на
                        развитии бизнеса — приходите к нам! В своей работе мы всегда делаем упор на качество и
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #ff2200, #e68a00)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        образовательной, медиа и развлекательной сферах. Также по запросу мы можем выполнить работы по
                        установке, тестированию и сопровождению заказных программ и баз данных.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #040212, #0a023c)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        мировых e-commerce технологий и делаем их простыми и доступными каждому. У нас восхитительная
                        поддержка. Мы постоянно учимся и не останавливаемся на достигнутом. Открыть интернет-магазин
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #656565, #55818E)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Мы — команда профессионалов, искренне увлечённых своим делом, любим методики Agile и работаем по
                        Scrum. Наша миссия — улучшать жизни людей с помощью современных технологий. Компания находится в
                        Ульяновске, крупном городе в 900 км от Москвы.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #419cb7, #00abff)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Advanced Software Development – одна из уникальных российских IT-компаний. Среди многих других
                        “молодых, динамично развивающихся” нас выгодно отличает наличие большого опыта создания
                        высококачественного программного обеспечения для многочисленных клиентов по всему миру, в том
                        числе таких компаний, как Яндекс и LG Electronics. Мы предоставляем полный пакет услуг по
                        разработке бизнес-приложений, игр и прочих программных продуктов - от сырой идеи до реализации и
                        последующей публикации.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #0e4a68, #ffa826)" p={[2, 4]}>
                      <HStack align="center">
                        <Image src={Webpower} h={['20px', '30px', '30px']} w={['20px', '30px', '30px']} />
                        <Link
                          fontSize={['xl', '2xl', '3xl']}
                          fontWeight="900"
                          color="white"
                          href="https://www.webpower.ru/#map"
                          isExternal
                        >
                          WEBPOWER
                        </Link>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        WEBPOWER-Разработка программного обеспечения для интернет-проектов.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #f50000, #279dc9)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        O-Planet - товарный знак, известный в сети с 2000-го года. В 2010-м году было зарегистрировано
                        О-Планет. В этом же году компания выиграла грант на проект разработки POS-систем. Это дало старт
                        развитию компании. Мы - это опытный и творческий коллектив, имеющий множество интересных идей и
                        готовых решений. Наша деятельность напрямую связана с автоматизацией бизнеса. Наша специализация
                        – торговые, производственные предприятия, заведения общепита. Мы - аутсорсинговая компания, а
                        наши клиенты - предприятия из разных городов.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #493a3a, #c04545)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Cоздаем и сопровождаем сайты. Мы работаем с проектами любой сложности: Информационный портал,
                        корпоративный сайт, интернет-магазин. Остаёмся на всё время жизни проекта и не бросаем своих
                        клиентов. Оказываем полный комплекс услуг по сопровождению веб-ресурсов. Дизайн сайта играет
                        большую роль, это практически лицо сайта. Мы серьёзно подходим к этому и разработаем дизайн
                        любой сложности.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #fc6d57, #f73315)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Лайфхакер — это издание для тех, кто хочет становиться лучше каждый день. Мы рассказываем обо
                        всём, что улучшает жизнь, доступно отвечаем на сложные вопросы, помогаем читателю решать
                        проблемы и делать повседневность осмысленной. Мы любим спорт, здоровье и путешествия,
                        рассказываем про отношения и финансы, делаем подборки фильмов и книг, пишем про новинки в сфере
                        технологий, устройства и полезные программы, делимся выгодными акциями, скидками и практическими
                        советами для всех сфер жизни.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #38D577, #2b7667)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        eCom Labs, перспективная компания, которая поможет вам организовать и развить свой online бизнес
                        на базе ПО CS-Cart и Multi-Vendor. В нашей компании работают настоящие профессионалы своего
                        дела, которые имеют опыт работы с CS-Cart более 9 лет и делали проекты различной сложности. Наши
                        специалисты не только помогут вам создать отличный магазин, но также и помогут вам сделать ваш
                        бизнес более успешным. Спектр наших услуг достаточно широк. Мы можем выполнить для вас как
                        небольшую модификацию, так и сайт под ключ. При этом вся работа будет выполнена для вас на
                        высшем уровне.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #04bf1d, #93c660)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        которой осуществляется работа со всеми проектами. В результате сегодня компания имеет большой
                        опыт в seo, который является мощнейшим инструментом по увеличению и стабилизации прибыли
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #80BF42, #5c984a)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        программные продукты полностью отвечают требованиям законодательства РФ и созданы в соответствии
                        с реальными потребностями всех задействованных сторон.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #FF81DA, #1AC14C)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Июнь-Софт – разработчик программного обеспечения для автоматизации и мониторинга ЖКХ и смежных
                        сфер. Благодаря сотрудничеству с управляющими и ресурсоснабжающими организациями, органами
                        государственной власти и местного самоуправления программные продукты полностью отвечают
                        требованиям законодательства РФ и созданы в соответствии с реальными потребностями всех
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #0F46B3, #2B95FF)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Бизнес Лидер — разработка и внедрение уникальных проектов с 2008 года. Мы группа профессионалов,
                        способная решить любые задачи Вашего бизнеса. Полное погружение в бизнес процессы вашей компании
                        позволит выделить сильные стороны этих процессов, маркетинга и внедрить их в работу сайта. Ваш
                        бизнес ставит перед нами цели, а мы их успешно реализуем. Прозрачность процессов позволяет вам
                        контролировать работу, а персональный менеджер всегда с вами на связи.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #093080, #0066C0)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Успешно работаем на рынке автоматизации, информационных услуг и консалтинга с 2000 года. Нашим
                        основным направлением деятельности является оказание услуг по внедрению и сопровождению программ
                        «1С:Предприятие». Также наша компания занимается поставкой других программных продуктов фирмы 1С
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #568900, #82FF39)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        успешно реализовано более 350 проектов. Наша основная специализация — это digital-решения для
                        государственных и медицинских учреждений. Все проекты созданы нашими специалистами с
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #97A8AC, #3AC2E4)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Компания Russian IT Group существует на рынке уже 17 лет. И хотя она фактически была основана в
                        2006 году, идея ее зарождения возникла еще в 2002 году.Совместные усилия и высокий уровень
                        ответственности в проектной деятельности способствует из года в год повышать процент успешно
                        реализованных проектов в оговоренные с клиентом сроки. Профессионалы, работающие в RITG (РИТГ),
                        взвешенно и эффективно подходят к решению задач, что является основой положительной обратной
                        связи со стороны клиентов.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #113D5E, #37C662)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        дизайна, а не версткой или программированием. Часто отходим от такого понятия, как «эффективные
                        часы», не скупимся на тестирование и слушаем наших партнеров во всем, что касается дизайн-идей.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #2C5277, #60778E)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Создаем сложные имитационные модели и системы планирования для поддержки принятия решений. Наши
                        имитационные модели и планировщики успешно используются в горно-рудной промышленности,
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #7D8A8A, #465066)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        компетенции – разработка электронных устройств для медицины, промышленности, ритейла, интернета
                        вещей и других отраслей. Мы выполняем полный цикл работ от проработки идей и концепций до
                        прототипирования и подготовки к серийному производству.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #66A9D5, #0181D7)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ООО ЭВМ-ТОРГ-СЕРВИС с 1992 г. занимается разработкой, внедрением и сопровождением программного
                        обеспечения. Совместно с ООО ИТ (главный разработчик), разработали и внедряем программное
                        обеспечение АС Системный Учет, позволяющее комплексно автоматизировать предприятия любой формы
                        собственности и вида деятельности. Программное обеспечение внедрено и сопровождается более чем в
                        150 предприятиях г. Ульяновска и Ульяновской области. С 2002 года плодотворно сотрудничаем с
                        корпорацией Парус и фирмой 1С по автоматизации бюджетных учреждений.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #1A3EB3, #0054E5)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        комплексные услуги интернет-маркетинга с 2012 года. Огромный опыт, квалифицированные сотрудники,
                        передовые технологии рынка и эксклюзивные собственные разработки позволяют нам на самом высоком
                        уровне оказывать своим клиентам весь комплекс услуг по развитию бизнеса в интернете.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #CA0000, #C06464)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        применить на практике бесконечно большое количество программно-технических решений с разных сфер
                        IT — индустрии, принять и осознать азы максимально удобного взаимодействия между нами,
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #5E18B9, #DF062A)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Мы создаем продукты, которые кардинально меняют работу в сфере обращения с отходами в России.
                        Наши решения помогают наладить прозрачную и эффективную работу с ТКО, автоматизировать все
                        процессы: от учёта данных и фиксирования фактов вывоза до автоматического построения маршрутов.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #5447C7, #775AB0)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        SIMDEV - Разработка адаптивных сайтов с индивидуальным дизайном. Наши сайты отлично выглядят на
                        любом устройтсве, и оптимизированы для голосового поиска.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #8F8DA1, #61606F)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Разработка сложных веб-проектов: Backend + Frontend. Стек технологий: PHP - Laravel, Symfony,
                        Yii 2 Node.js - Express.js Js - React.js, Vue.js, Angular DB - PostgreSQL, MySql, MongoDB
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #EB9500, #FF6600)" p={[2, 4]}>
                      <HStack align="center">
                        <Link
                          ...
                          isExternal
                        >
                          ZEBRA COROPRATE DIGITAL
                        </Link>
                      </HStack>
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Мы — лидеры российского рынка корпоративных сайтов с международным признанием. Мы сопровождаем
                        наших клиентов по всему циклу корпоративных digital-коммуникаций: создаем коммуникационные
                        стратегии, разрабатываем IR- и корпоративные сайты, сопровождаем и развиваем их.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #0053D0, #074094)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        клиентам: Подбор, конфигурирование, обслуживание оборудования, серверов, систем хранения данных
                        Создание и обслуживание современной информационной инфраструктуры (Windows, Linux). Аутсорсинг
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #8132AF, #4B0B70)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Мы создаем и внедряем передовые технологии для развития интеллектуальной инфраструктуры городов
                        и регионов, эффективного управления транспортом и создания комфортных условий проживания
                        горожан. В портфеле компании – решения для интеллектуальных транспортных систем, городского
                        общественного транспорта и цифровых городских сервисов.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #123891, #001F68)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ИТ-партнёр лидеров рынка России и стран СНГ. С 2005 года команда профессионалов HTDev помогает
                        среднему и крупному бизнесу в России и странах СНГ решать сложные задачи и достигать намеченных
                        целей.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #12151C, #050912)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Разрабатываем UX/UI дизайн, сайты, маркетплейсы, мобильные приложения, E-com и EdTech решения
                        для среднего и крупного бизнеса. Оказываем техническую поддержку. Только то, что нужно бизнесу.
                        Ничего лишнего.
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #3B6487, #377EBC)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        Хекслет сейчас — экосистема, в которую входят онлайн-платформа для обучения программированию,
                        колледж и серия опенсорс-проектов
                      </Text>
                    </GridItem>
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #3D6B7C, #3C8CD1)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ...
                        стабильную работу компьютерной техники и программного обеспечения предприятий города Ульяновска.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #E1DA24, #E2001E)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        Компания «Квадрат 2» с 2016 года помогает директорам, руководителям разных уровней и владельцам
                        средних по размерам производств автоматизировать бизнес-процессы с помощью 1С:Предприятие. На
                        начало 2023 года в компании работает более 10 человек опытных специалистов различных профилей.
                      </Text>
                    </GridItem>
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #19C725, #C7B019)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        ГК «АгроСервис-ИТ» как партнер фирмы «1С» работает в Ульяновском регионе с 2009 года. Изначально
                        мы понимали, насколько сложной и ответственной является задача учета на предприятия
                        агропромышленного комплекса. Поэтому, основные наши усилия направлены на автоматизацию
                        управленческого и бухгалтерского учета в сельском хозяйстве. Сегодня, по прошествии 8 лет, в
                        нашем клиентском портфеле предприятия самых различных отраслей, но сохранение компетенций и
                        знаний в автоматизации управленческого и бухгалтерского учета в растениеводстве и животноводстве
                    ...
                    <GridItem borderRadius="10px" w="full" bgGradient="linear(to-r, #C4A346, #DE7600)" p={[2, 4]}>
                      ...
                      <Text fontSize={['sm', 'sm', 'md']}>
                        В нашем магазине вы можете приобрести сборки операционной системы Ульяновск.BSD для настольных
                        компьютеров. Наши сборки создаются на базе свободно-распространяемой операционной системы
                        FreeBSD.
                      </Text>
                    </GridItem>
